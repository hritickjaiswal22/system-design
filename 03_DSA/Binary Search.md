...
This is a **very good classification**, but if your goal is **good interview preparation**, I'd make one important change.
...
| **"Minimize the maximum **_" / "maximize the minimum _**"**                                                                                      | Binary search on answer           | C       |
...
- **Not stating the loop invariant before coding.** At a good bar you're expected to say "I'm maintaining the invariant that `lo` is always infeasible and `hi` is always feasible" _before_ writing a single line. Silent coding reads as pattern-memorization, not understanding.
